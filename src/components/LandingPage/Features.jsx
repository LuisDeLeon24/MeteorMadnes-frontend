    ...
    return (
        <MotionVStack
            ...
            _hover={{
                ...
                boxShadow: '0 25px 60px rgba(59, 130, 246, 0.2), 0 0 40px rgba(147, 197, 253, 0.1)',
                _before: {
                    opacity: 1,
                }
            }}
        >
            ...
            {/* Efecto de constelación animada */}
            <Box
                position="absolute"
                top="15%"
                right="10%"
            ...
            <Box position="relative" zIndex={1} width="100%">
                ...
                {/* Indicador de acción con efecto de propulsión */}
                <Flex
                    align="center"
                    mt="auto"
