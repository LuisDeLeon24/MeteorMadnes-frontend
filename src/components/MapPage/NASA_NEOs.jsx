    ...
    <VStack spacing={4} position="relative" zIndex={2}>
      ...
      <VStack spacing={2}>
        <Text color="white" fontWeight="bold" fontSize="md">
          Consultando NASA NEOS
        </Text>
        <Text color="rgba(147, 197, 253, 0.7)" fontSize="sm" textAlign="center">
          Obteniendo datos del asteroide desde JPL...
        </Text>
      </VStack>
      ...
      >
        <HStack spacing={2}>
          ...
          <Text color="rgba(245, 158, 11, 0.9)" fontSize="xs" lineHeight="1.4">
            Intente usar otro ID o nombre de asteroide, o consulte otra fuente (JPL HORIZONS o IAU NeoCP).
          </Text>
        </HStack>
      </Box>
    </VStack>
    ...
    <VStack spacing={4}>
      ...
      <VStack spacing={2}>
        ...
        <Text color="rgba(147, 197, 253, 0.7)" fontSize="sm" textAlign="center" lineHeight="1.4">
          Ingrese un nombre o ID de asteroide para obtener datos detallados de NASA NEOS
        </Text>
      </VStack>
                ...
                <VStack align="flex-start" spacing={0} flex={1}>
                  ...
                  <HStack spacing={2}>
                    <Badge
                      ...
                      fontSize="xs"
                    >
                      {isPotentiallyHazardous ? "⚠️ Potencialmente Peligroso" : "✅ No Peligroso"}
                    </Badge>
                    <Badge
                      colorScheme="blue"
                      variant="subtle"
              ...
              <VStack spacing={4} width="100%" align="stretch">
                <VStack spacing={3} align="stretch">
                  ...
                  <SimpleGrid columns={2} spacing={3}>
                    ...
                    <MetricCard
                      icon={Ruler}
                      title="Diámetro Mínimo"
                      value={diameterMin ? `${diameterMin.toFixed(3)} km` : "N/A"}
                      color="#10b981"
                      delay={0.2}
                      subtitle="Estimación inferior"
                    />
                    <MetricCard
                      icon={Ruler}
                      title="Diámetro Máximo"
                      value={diameterMax ? `${diameterMax.toFixed(3)} km` : "N/A"}
                      color="#06b6d4"
                      delay={0.25}
                      subtitle="Estimación superior"
                    />
                  </SimpleGrid>
                  ...
                  {avgDiameter && (
                    <MetricCard
                      icon={Target}
                      title="Diámetro Promedio Estimado"
                      value={`${avgDiameter} km`}
                      color="#ec4899"
                      delay={0.3}
                      subtitle="Valor medio calculado"
                      isHighlight={true}
                    />
                  )}
                </VStack>
                ...
                <VStack spacing={3} align="stretch">
                  ...
                  <SimpleGrid columns={1} spacing={3}>
                    <MetricCard
                      ...
                      color="#ec4899"
                      delay={0.35}
                      subtitle="Identificador orbital"
                    />
                    <MetricCard
                      icon={Calendar}
                      title="Determinación Orbital"
                      value={d.orbital_data?.orbit_determination_date}
                      color="#14b8a6"
                      delay={0.4}
                      subtitle="Fecha de cálculo"
                    />
                    <MetricCard
                      icon={Eye}
                    ...
                    <MetricCard
                      ...
                      color="#ef4444"
                      delay={0.5}
                      subtitle="Observación más reciente"
                    />
                    <MetricCard
                      icon={TrendingUp}
                      title="Observaciones Utilizadas"
                      value={d.orbital_data?.observations_used}
                      color="#8b5cf6"
                      delay={0.55}
                      subtitle="Datos para cálculo orbital"
                    />

                    {d.orbital_data?.orbit_class && (
                      <MetricCard
                        icon={Globe}
                        title="Clase de Órbita"
                ...
                >
                  <VStack spacing={3}>
                    ...
                    >
                      ...
                      >
                        Ver en NASA JPL Database
                      </Button>
                    </Link>

                    <Text color="rgba(147, 197, 253, 0.6)" fontSize="xs" textAlign="center">
                      Accede a datos técnicos completos y trayectoria orbital
                    </Text>
                  </VStack>
                </Box>
              )}
