...
FITS.prototype.setNewImage = function(filename, fitsab) {
    ...
    try {
        ...
        throw (this.filename + ": unknown file format: " + e);
    }
    ...
    if (!(this.header.SIMPLE &&
        ...
        throw (this.filename + ": unsupported file format");
    }
...
FITS.prototype.updateGlass = function() {
    ...
    if (this.userGlassCanvas != undefined) {
        ...
        ug_ctx.beginPath();
        ug_ctx.moveTo(cw / 2, 0);
        ug_ctx.lineTo(cw / 2, size);
        ug_ctx.moveTo(cw / 2, ch);
        ug_ctx.lineTo(cw / 2, ch - size);
        ug_ctx.moveTo(0, ch / 2);
        ug_ctx.lineTo(size, ch / 2);
        ug_ctx.moveTo(cw, ch / 2);
        ug_ctx.lineTo(cw - size, ch / 2);
        ug_ctx.stroke();
    }
}
